...
import { OPENAI_CHATGPT_ACCESS_TOKEN_ENV_KEY, OPENAI_CHATGPT_ACCOUNT_ID_ENV_KEY, OPENAI_CHATGPT_EMAIL_ENV_KEY, OPENAI_CHATGPT_EXPIRES_AT_ENV_KEY, OPENAI_CHATGPT_PLAN_ENV_KEY, OPENAI_CHATGPT_REFRESH_TOKEN_ENV_KEY, } from "../constants.js";
/**
...
export function createCodexFetch(modelId, fetchImpl = globalThis.fetch) {
    return async (input, init) => {
        const useLunaProtocol = modelId === CODEX_LUNA_MODEL_ID && isCodexResponsesRequest(input);
