...
import { readOpenWikiOnboardingConfig, } from "./onboarding.js";
import { ensureOpenWikiHome, getConnectorConfigPath, openWikiLocalWikiDir, } from "./openwiki-home.js";
...
function createSourceSynthesisPolicy(connectorId) {
    return `
...
function createConnectorSynthesisGuidance(connectorId) {
    switch (connectorId) {
        case "google":
            return `
