...
import { getConnectorConfigPath, getConnectorRawDir, openWikiHomeDir, openWikiLocalWikiDir, resolveConnectorRawPath, } from "../openwiki-home.js";
...
export function createOpenWikiConnectorTools() {
    return [
        ...
        new DynamicStructuredTool({
            ...
            description: 'List live MCP tools for a configured MCP connector and write discovery under ~/.openwiki/connectors/<id>/raw. Input: {"connectorId":"notion"}. Use exact returned tool names.',
            schema: {
                type: "object",
                properties: {
                    connectorId: {
        ...
        new DynamicStructuredTool({
            ...
            description: 'Call one exact discovered read-only MCP tool and write the result under ~/.openwiki/connectors/<id>/raw. Input: {"connectorId":"notion","toolName":"exact_tool_name","args":{"query":"Applied AI"}}.',
            schema: {
                type: "object",
                properties: {
                    args: {
        ...
        new DynamicStructuredTool({
            ...
            description: 'Run deterministic ingestion for one built-in connector and write raw data/manifests under ~/.openwiki/connectors/<id>/raw. Input: {"connectorId":"x","streams":["bookmarks"],"limit":1}.',
            schema: {
                type: "object",
                properties: {
                    connectorId: {
        ...
        new DynamicStructuredTool({
            ...
            description: 'List raw files for a connector under ~/.openwiki/connectors/<id>/raw. Input: {"connectorId":"x"}.',
            schema: {
                type: "object",
                properties: {
                    connectorId: {
        ...
        new DynamicStructuredTool({
            ...
            description: 'Read a raw connector file by connector ID and relative path. Only files inside ~/.openwiki/connectors/<id>/raw are allowed. Input: {"connectorId":"x","path":"2026-.../bookmarks.json","maxBytes":50000}.',
            schema: {
                type: "object",
                properties: {
                    connectorId: {
