...
export const writeConnectorSkillPath = path.join(openWikiSkillsDir, "write-connector.md");
export async function ensureWriteConnectorSkill() {
    ...
    await writeFile(writeConnectorSkillPath, `${WRITE_CONNECTOR_SKILL.trim()}\n`, {
        encoding: "utf8",
        mode: 0o600,
    });
}
